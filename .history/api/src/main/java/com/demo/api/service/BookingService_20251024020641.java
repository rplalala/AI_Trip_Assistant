...
/**
 * BookingService defines the contract for handling trip-related bookings.
 * This includes quoting individual or bundled trip items and confirming bookings
 * with a third-party Booking API.
 */
