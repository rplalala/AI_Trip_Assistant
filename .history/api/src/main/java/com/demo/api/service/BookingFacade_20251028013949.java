...
public class BookingFacade {
    ...
    /**
     * Delegates single-item quote handling to BookingService while keeping orchestration in the facade.
     */
    @Transactional
    public QuoteResp quote(QuoteReq request, String userId) {
        ...
        // Delegate quote logic to BookingServiceImpl (handles validation, API call, DB insert)
