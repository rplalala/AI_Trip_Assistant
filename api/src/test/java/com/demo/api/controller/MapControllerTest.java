...
class MapControllerTest {
    ...
    void generateRoute_returnsServiceResult() throws Exception {
        MapRouteRequest request = new MapRouteRequest("Sydney", "Canberra", "driving");
        MapRouteResponse response = MapRouteResponse.builder()
                ...
                .build();
        when(mapService.generateRoute(request)).thenReturn(response);
        ...
        verify(mapService).generateRoute(captor.capture());
